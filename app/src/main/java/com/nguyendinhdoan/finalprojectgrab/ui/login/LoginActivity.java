...
import com.nguyendinhdoan.finalprojectgrab.ui.passenger.PassengerActivity;
import com.nguyendinhdoan.finalprojectgrab.ui.phone.PhoneActivity;
...
public class LoginActivity extends AppCompatActivity implements LoginContract.LoginToView,
    ...
    private void launchPassenger() {
        Intent intentPassenger = new Intent(this, PassengerActivity.class);
    ...
    public void afterTextChanged(Editable s) {
        ...
        if (!CommonUtil.validatePhone(etPhone.getText().toString())) {
